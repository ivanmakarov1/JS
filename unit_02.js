...
let d = 9;
let result2 = c / d;
//let div = document.querySelector('.out-2'); еще вариант получения результата.
...
let e1 = "3";
let f1 = 5;
let f11 = "конкатенация";
let result4 = e1 + f1 + " " + f11;
...
function t9() {
  let a9 = document.querySelector(".i-9").value; // получили значение
...
function t10() {
  ...
  document.querySelector(".out-10").innerHTML = a10 * 20;
}
...
function t11() {
  ...
  document.querySelector(".out-11").innerHTML = a11 + 55;
}
...
function t12() {
  let ff4 = "Hello";
  let a12 = document.querySelector(".i-12-1").value;
  let a122 = document.querySelector(".i-12-2").value;
  document.querySelector(".out-12").innerHTML = ff4 + " " + a12 + " " + a122;
}
...
function t19() {
  ...
  document.querySelector(".out-19").innerHTML = a19 * b19;
}
